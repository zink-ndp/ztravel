<div class="header-bottom hidden-sm hidden-xs">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-9 padding-top-2px">
                        <div class="row">
                            <div class="header-search-bar layout-01 ">
                                <form action="#" class="form-search" name="desktop-seacrh" method="get">
                                    <input type="text" name="s" class="input-text" value="" placeholder="Search here...">
                                    <select name="category">
                                        <option value="-1" selected>Tất cả Tour</option>
                                        <option value="vegetables">Trong nước</option>
                                        <option value="fresh_berries">Nước ngoài</option>
                                    </select>
                                    <button type="submit" class="btn-submit"><i class="biolife-icon icon-search"></i></button>
                                </form>
                            </div>
                            <div class="col-lg-4 col-md-3"></div>
                            <div class="live-info col-lg-4 col-md-3">
                                <p class="telephone"><i class="fa fa-phone" aria-hidden="true"></i><b class="phone-number">(+84) 377 789 9959</b></p>
